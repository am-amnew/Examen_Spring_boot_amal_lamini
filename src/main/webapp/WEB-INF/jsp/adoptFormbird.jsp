...
<main>
    ...
    <div class="headline">
        <h2 class="text-headline">Adopter Bird</h2>
    ...
    <form  action="${pageContext.request.contextPath}/adoptions/adoptBird" method="post">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var adoptFormbird = document.getElementById('adoptFormbird');
