...
<main>
  <figure>
    <picture>
      ...
      <img       
      src="https://i.pinimg.com/564x/b2/8a/21/b28a214e066327c1c5afe67dc4144016.jpg"
                 alt="Citymap illustration" />
    </picture>
  </figure>
  <div class="headline">
    <h2 class="text-headline">Adopter Chien</h2>
    <h3 class="text-subheadline">Opening hearts, one paw at a time. Add a dog for adoption, and let the journey of unconditional love begin.</h2>
  </div>
  
  
  
    <form  action="${pageContext.request.contextPath}/adoptions/adopt" method="post">
